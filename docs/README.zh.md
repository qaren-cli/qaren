...
## 为什么选择 Qaren？ [<img src="../icons/favicon.png" width="24" height="24">](https://qaren.me) &nbsp; [<img src="../icons/icons8-linkedin-48.png" width="24" height="24">](https://www.linkedin.com/in/alielesawy) &nbsp; [<img src="../icons/icons8-github-48.png" width="24" height="24">](https://github.com/alielesawy)
...
- **极速性能**：使用 Rust 优化，处理 GB 级 system backups 和 10 万级键值对的速度比传统 diff 流水线快达 **200 倍**。
...
### 2. 增强的字面量输出
Qaren 提供比 POSIX diff 更清晰的逐行对比，特别针对 system backups 文件分析进行了优化。

<p align="center">
  <b>传统 POSIX Diff</b><br>
  <img src="../icons/diff.gif" width="100%" alt="Traditional POSIX Diff">
</p>

<p align="center">
  <b>Qaren 增强 Diff</b><br>
...
Qaren 的 `kv` 模式专为真实世界的 DevOps 任务设计。以下所有示例均使用这两个环境文件中显示的数据进行测试：

<p align="center">
  <img src="../icons/dev_env.svg" width="45%" alt="开发环境">
  <img src="../icons/staging_env.svg" width="45%" alt="测试环境">
</p>
