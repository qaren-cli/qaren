...
## なぜ Qaren なのか？ <img src="../icons/favicon.png" width="24" height="24"> &nbsp; [<img src="../icons/icons8-linkedin-48.png" width="24" height="24">](https://www.linkedin.com/in/alielesawy) &nbsp; [<img src="../icons/icons8-github-48.png" width="24" height="24">](https://github.com/alielesawy)
...
### 3. スマートなノイズ低減
KV モードで JSON バックアップを比較していますか？ `-D` で重複キーの警告を抑制し、 `-P` で権限の警告を消音できます。Qaren は自動的にファイルごとの警告を 5 つまでに制限し、ターミナルをクリーンに保ちます。
